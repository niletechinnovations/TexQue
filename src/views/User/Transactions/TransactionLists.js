...
class TransactionLists extends Component {
  constructor(props){
    ...
    this.state = {
      ...
      loading: true,
      rowIndex: -1,
      formField: { subscriberId: '', transactionProfileId: '', planName: '', planTypeLabel:'', planDuration:'', status:'', startDate:'', endDate:'', createdAt:'' },
    } 
  ...
  toggle = () => {
    this.setState({
      ...
      rowIndex: -1,
      formField: { subscriberId: '', transactionProfileId: '', planName: '', planTypeLabel:'', status:'', startDate:'', endDate:'', createdAt:'' },
    });
  }
              ...
              <Row>
                <Col md={"6"}>
                  <FormGroup> 
                    ...
                    <Input type="text" placeholder="Subscriber Id" id="subscriberId" name="subscriberId" value={formField.subscriberId} disabled />
                  </FormGroup>  
                </Col>
                <Col md={"6"}>
                  <FormGroup> 
                    <Label htmlFor="transactionProfileId">Transaction ProfileId</Label>            
                    <Input type="text" placeholder="Transaction ProfileId" id="transactionProfileId" value={formField.transactionProfileId} disabled />
                  </FormGroup>
                </Col>
                <Col md={"6"}>
                  <FormGroup> 

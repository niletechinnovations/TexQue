                ...
                <div className="account-form">
                  ...
                  <Form onSubmit={this.submituserRegistrationForm} noValidate>
                    <Row form>
                      <Col md={6}>
                        <FormGroup>
                          ...
                          <Input type="text" name="firstName" id="firstName" value={firstName} onChange={this.changeHandler} placeholder="First Name *" required />
                      ...
                      <Col md={6}>
                        <FormGroup>
                          ...
                          <Input type="text" name="lastName" id="lastName" value={lastName} onChange={this.changeHandler} placeholder="Last Name *" required />
                      ...
                      <Col md={6}>
                        <FormGroup>
                          ...
                          <Input type="number" name="phoneNumber" id="phoneNumber" placeholder="Mobile no. *" value={phoneNumber} onChange={this.changeHandler} required />
                      ...
                      <Col md={6}>
                        <FormGroup>
                          ...
                          <Input type="password" name="password" id="password" value={password} onChange={this.changeHandler} placeholder="Enter Password" required />
                      ...
                      <Col md={6}>
                        <FormGroup>
                          ...
                          <Input type="password" name="confirmPassword" id="confirmPassword" value={confirmPassword} onChange={this.changeHandler}  placeholder="Re-enter Password" required />
                    ...
                    <FormGroup>
                      ...
                      <Input type="text" name="organizationName" id="organizationName" placeholder="Organization Name" required/>
